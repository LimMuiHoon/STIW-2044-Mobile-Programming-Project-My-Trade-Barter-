...
class _CreateNewBarterState extends State<CreateNewBarter> {
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: <Widget>[
              ...
              new IconButton(
                  iconSize: 40, icon: new Icon(Icons.tv), onPressed: _changeTv),
              new IconButton(
                  iconSize: 40,
                  icon: new Icon(Icons.watch),
                  onPressed: _changeWatch),
              new IconButton(
                  iconSize: 40,
                  icon: new Icon(Icons.directions_bike),
                  onPressed: _changeBike),
              new IconButton(
                  iconSize: 40,
                  icon: new Icon(Icons.directions_bike),
                  onPressed: null),
  ...
  void _changeBook() {
    _bartercontroller.text = "Book";
  }

  void _changePhone() {
    _bartercontroller.text = "Smart Phone";
  }

  void _changeTv() {
    _bartercontroller.text = "TV";
  }

  void _changeWatch() {
    _bartercontroller.text = "Watch";
  }

  void _changeBike() {
    _bartercontroller.text = "Bike";
  }
}
